			...
			<section id='section4-works' class='section full-height-section' name='works'>
				<div class='container'>
					...
					<div class='row'>
						...
						$pemisah_desimal =",";
						$pemisah_ribuan =".";
						$ekstrakulikuler = $ekstra->getEkstrakulikuler(0,3);
						...
						<div class='col s12'>
							<div class='card featured'>
								<a href='http://www.ayobantumasjid.com/donasi' target='_blank'>
									<div class='card-image'> ";
									if(!empty($ekstrakulikuler['gambar'])){   
						                  echo" <img src='".ROOT."images/content/ekskul/thumbnails/".$ekstrakulikuler['gambar']."'/>";
						              }else{

						                  echo" <img src='".ROOT."images/content/logo.png'/>";
									...
									<div class='card-content'>
										<p class='project-title'><a href='".ROOT.'ekstrakulikuler/'.$ekstrakulikuler['id'].'/'.$ekstrakulikuler['link']."'> ".$ekstrakulikuler['judul']." </a> </p> 
										 
										<p class='project-description'><br>".$ekstrakulikuler['isi']." <br>
										Kami dari Yayasan Ayo Bantu Masjid mengajak saudara/i untuk membantu memberangkatkan Umroh Dg. Nyampo sebagai impian yang belum pernah tercapai oleh beliau.</p>
					             		<p class='progress-container'>
					             			<span class='progress-empty-background'></span>
					             			<span class='progress-bar'></span>
					             			<span class='progress-label'>Progress <span class='progress-value'>".$ekstrakulikuler['persentase']."</span>% </span>
					             		</p>
					             		<p class='target-label'>Dibutuhkan <span class='target-value'>Rp ".number_format($ekstrakulikuler['targetdana'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."</span></p>
					             		<p class='collected-label'>Terkumpul <span class='collected-value'>Rp ".number_format($ekstrakulikuler['danasekarang'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."</span></p>
					             		<p class='deadline-label'><span class='deadline-value'>PROYEK BERAKHIR, TARGET TERCUKUPI</span></p>
					             		<br>
<!--					             		
<a href='http://www.ayobantumasjid.com/donasi' target='_blank' class='waves-effect waves-light'>BANTU DONASI</a>-->
									</div>
